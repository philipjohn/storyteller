...
class Storyteller_Plugin {
	...
	function add_filter ($action, $function = '', $priority = 10, $accepted_args = 1) {
		add_filter ($action, array ($this, $function == '' ? $action : $function), $priority, $accepted_args);
	}
	 ...
	 * @author © John Godley
	 **/
	function remove_filter ($action, $function = '', $priority = 10, $accepted_args = 1) {
		remove_filter ($action, array ($this, $function == '' ? $action : $function), $priority, $accepted_args);
	}
	 ...
	 * @param callable|null $func Hook to run when shortcode is found.
	 */
